...
window.LOUDOUN = {
  ...
  cards: [
    // --- LIVE ---
    { id: 'air',      icon: '🌱', title: 'AIR QUALITY',      tier: 'live',  liveKey: 'air',     countyVal: '--', districtVal: null, sub: 'Ashburn EPA monitor - fetched live', color: '#4ade80', spark: [55,52,48,45,44,42,43,42], source: 'airnow.gov',           sourceUrl: 'https://www.airnow.gov/?city=Ashburn&state=VA',                              method: 'LIVE API' },
    { id: 'weather',  icon: '🌤', title: 'WEATHER',           tier: 'live',  liveKey: 'weather', countyVal: '--', districtVal: null, sub: 'Dulles Airport grid, NWS - fetched live', color: '#38bdf8', spark: [62,65,68,72,70,74,72,71], source: 'api.weather.gov',     sourceUrl: 'https://api.weather.gov',                                                    method: 'LIVE API' },
    { id: 'water',    icon: '💧', title: 'WATER LEVEL',       tier: 'live',  liveKey: 'water',   countyVal: '--', districtVal: null, sub: 'Goose Creek gauge 01636500, USGS - live', color: '#60a5fa', spark: [3.2,3.5,3.8,4.1,3.9,3.7,3.5,3.4], source: 'waterdata.usgs.gov', sourceUrl: 'https://waterdata.usgs.gov/nwis/uv?site_no=01636500',                     method: 'LIVE API' },
    { id: 'metro',    icon: '🚇', title: 'SILVER LINE',       tier: 'live',  liveKey: 'wmata',   countyVal: '--', districtVal: null, sub: 'Loudoun Gateway + Ashburn - click map', color: '#a78bfa', spark: [1200,1400,1600,1800,2100,2400,2600,2800], source: 'wmata.com',      sourceUrl: 'https://www.wmata.com',                                                      method: 'LIVE API' },
    { id: 'outages',  icon: '⚡', title: 'POWER OUTAGES',     tier: 'live',  liveKey: 'outages', countyVal: '--', districtVal: null, sub: 'Dominion Energy active outages, Loudoun County', color: '#facc15', spark: [0,2,1,4,1,0,2,1], source: 'dominiorenergy.com',  sourceUrl: 'https://www.dominionenergy.com/outages',                                     method: 'LIVE API' },
    // --- TODAY ---
    { id: 'permits',  icon: '🏗', title: 'BUILDING PERMITS',  tier: 'today', liveKey: 'permits', countyVal: '--', districtVal: null, districtNote: 'County-wide', sub: 'Active permits from Loudoun Open Data today', color: '#ff6b35', spark: [280,260,305,290,312,300,298,312], source: 'opendata.loudoun.gov', sourceUrl: 'https://opendata.loudoun.gov', method: 'OPEN DATA API' },
    // --- PUBLISHED ---
    { id: 'budget',    icon: '💰', title: 'COUNTY BUDGET',    tier: 'published', publishedDate: 'Apr 1, 2025',        countyVal: '$4.7B',        districtVal: null, sub: 'FY2026 adopted. FY2027 $5.4B adopted Apr 7 2026.', color: '#22c55e', spark: [3.1,3.2,3.35,3.5,3.6,3.72,3.87,4.7],  source: 'loudoun.gov/budget',        sourceUrl: 'https://www.loudoun.gov/budget',                                             method: 'PDF' },
    { id: 'enrollment',icon: '🏫', title: 'LCPS ENROLLMENT',  tier: 'published', publishedDate: 'Aug 2025',           countyVal: '~82,000',      districtVal: null, sub: '100 schools, 2025-26. Down from 84,121 prior year.', color: '#2dd4bf', spark: [70000,74000,77000,79000,81000,84121,84000,82000], source: 'lcps.org',              sourceUrl: 'https://www.lcps.org/article/2361206',                                      method: 'STATIC' },
    { id: 'population',icon: '📈', title: 'POPULATION',       tier: 'published', publishedDate: 'Mar 27, 2026',       countyVal: '449,749',      districtVal: null, sub: 'Census 2025 est. Up 25,720 since 2020 census.', color: '#fbbf24', spark: [310,340,370,400,420,436,443,450],           source: 'fred.stlouisfed.org',       sourceUrl: 'https://fred.stlouisfed.org/series/VALOUD5POP',                             method: 'API' },
    { id: 'housing',   icon: '🏠', title: 'MEDIAN HOME PRICE',tier: 'published', publishedDate: 'Feb 2026',           countyVal: '$774K',        districtVal: null, sub: 'Up 3.0% YoY. 307 homes sold, avg 34 days on market.', color: '#f5c842', spark: [545,580,600,620,641,680,720,774],        source: 'redfin.com',                sourceUrl: 'https://www.redfin.com/county/2989/VA/Loudoun-County/housing-market',        method: 'COLLECTED' },
    { id: 'safety',    icon: '👮', title: 'CRIME INDEX',       tier: 'published', publishedDate: 'Aug 2025 (nightly)',countyVal: '-14% (2025)',   districtVal: null, sub: 'Serious crime down 14% in 2025. Dashboard updates nightly.', color: '#fb923c', spark: [100,98,96,94,92,90,88,86],       source: 'loudoun.gov/crimedashboard',sourceUrl: 'https://www.loudoun.gov/crimedashboard',                                     method: 'COLLECTED' },
    { id: 'schools',   icon: '📚', title: 'SCHOOL RATING',    tier: 'published', publishedDate: '2026 School Year',  countyVal: '9/10 avg',     districtVal: null, sub: 'Top 20% VA. Math 76%, Reading 79%. 101 schools, 80,096 students.', color: '#00c6ff', spark: [7.2,7.5,7.8,8.0,8.1,8.2,8.4,9.0], source: 'publicschoolreview.com',   sourceUrl: 'https://www.publicschoolreview.com/virginia/loudoun-county',                 method: 'COLLECTED' },
    { id: 'bosvotes',  icon: '🗳', title: 'BOS ACTIVITY',     tier: 'published', publishedDate: 'Apr 7, 2026',       countyVal: 'FY2027 Budget',districtVal: null, sub: 'Apr 7 2026: $5.4B FY2027 adopted. Meets 1st + 3rd Tuesday.', color: '#f472b6', spark: [2,3,5,4,6,3,4,4],              source: 'loudoun.gov/bos',           sourceUrl: 'https://www.loudoun.gov/86/Board-of-Supervisors',                           method: 'STATIC' },
    { id: 'elections', icon: '🗳', title: 'ELECTIONS',         tier: 'published', publishedDate: 'Nov 2023',          countyVal: 'Nov 2027 next',districtVal: null, sub: 'Last general election Nov 7 2023. All 9 supervisors + chair. Next: Nov 2027.', color: '#e879f9', spark: [0,0,0,0,0,0,0,1],   source: 'loudoun.gov/elections',     sourceUrl: 'https://www.loudoun.gov/elections',                                         method: 'STATIC' },
    { id: 'foia',      icon: '📋', title: 'FOIA / OPEN RECORDS',tier: 'published', publishedDate: 'Current',         countyVal: 'File Online',  districtVal: null, sub: 'Virginia FOIA: 5 business days to respond. Free for first 2hrs of staff time.', color: '#94a3b8', spark: [10,12,14,15,18,20,22,24], source: 'loudoun.gov/foia',          sourceUrl: 'https://www.loudoun.gov/foia',                                               method: 'STATIC' },
