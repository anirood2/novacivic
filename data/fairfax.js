...
window.FAIRFAX = {
  ...
  cards: [
    // --- LIVE ---
    { id: 'air',      icon: '🌱', title: 'AIR QUALITY',       tier: 'live',  liveKey: 'air',     countyVal: '--', districtVal: null, sub: 'Tysons Corner EPA monitor - fetched live', color: '#4ade80', spark: [58,54,50,46,44,40,38,38], source: 'airnow.gov',           sourceUrl: 'https://www.airnow.gov/?city=Tysons+Corner&state=VA',                             method: 'LIVE API' },
    { id: 'weather',  icon: '🌤', title: 'WEATHER',            tier: 'live',  liveKey: 'weather', countyVal: '--', districtVal: null, sub: 'Tysons Corner grid, NWS - fetched live',  color: '#38bdf8', spark: [60,63,67,70,68,72,70,69], source: 'api.weather.gov',     sourceUrl: 'https://api.weather.gov',                                                         method: 'LIVE API' },
    { id: 'water',    icon: '💧', title: 'WATER LEVEL',        tier: 'live',  liveKey: 'water',   countyVal: '--', districtVal: null, sub: 'Difficult Run gauge 01655500, USGS - live',color: '#60a5fa', spark: [2.8,3.1,3.4,3.7,3.5,3.3,3.1,3.0], source: 'waterdata.usgs.gov', sourceUrl: 'https://waterdata.usgs.gov/nwis/uv?site_no=01655500',                          method: 'LIVE API' },
    { id: 'metro',    icon: '🚇', title: 'SILVER LINE',        tier: 'live',  liveKey: 'wmata',   countyVal: '--', districtVal: null, sub: 'Wiehle, Herndon, Innovation, Dulles, Tysons - click map', color: '#a78bfa', spark: [8200,9100,10400,12100,14200,16800,19100,21000], source: 'wmata.com', sourceUrl: 'https://www.wmata.com',                                                      method: 'LIVE API' },
    { id: 'outages',  icon: '⚡', title: 'POWER OUTAGES',      tier: 'live',  liveKey: 'outages', countyVal: '--', districtVal: null, sub: 'Dominion Energy active outages, Fairfax County', color: '#facc15', spark: [0,3,2,5,1,0,2,1], source: 'dominionenergy.com',   sourceUrl: 'https://www.dominionenergy.com/outages',                                          method: 'LIVE API' },
    // --- TODAY ---
    { id: 'permits',  icon: '🏗', title: 'BUILDING PERMITS',   tier: 'today', liveKey: 'permits', countyVal: '--', districtVal: null, districtNote: 'County-wide', sub: 'Active permits from Fairfax Open Data today', color: '#ff6b35', spark: [720,750,800,780,820,810,835,842], source: 'data.fairfaxcounty.gov', sourceUrl: 'https://data.fairfaxcounty.gov', method: 'OPEN DATA API' },
    // --- PUBLISHED ---
    { id: 'budget',    icon: '💰', title: 'COUNTY BUDGET',     tier: 'published', publishedDate: 'May 2025',       countyVal: '$4.9B + $3.9B',  districtVal: null, sub: 'FY2026: $4.9B county + $3.9B FCPS. Avg $21,986/student.', color: '#22c55e', spark: [8.2,8.6,9.0,9.3,9.6,9.8,10.0,8.8], source: 'fairfaxcounty.gov/budget', sourceUrl: 'https://www.fairfaxcounty.gov/budget', method: 'PDF' },
    { id: 'enrollment',icon: '🏫', title: 'FCPS ENROLLMENT',   tier: 'published', publishedDate: 'Mar 2026',       countyVal: '~183,000',       districtVal: null, sub: 'Largest school system in VA. 93.3% graduation rate.', color: '#2dd4bf', spark: [168000,172000,175000,177000,178000,179000,181000,183000], source: 'fcps.edu',  sourceUrl: 'https://www.fcps.edu/about-fcps', method: 'STATIC' },
    { id: 'population',icon: '📈', title: 'POPULATION',        tier: 'published', publishedDate: 'Mar 27, 2026',   countyVal: '1,167,873',      districtVal: null, sub: 'Census 2025 est. Declining every year since 2020 census.', color: '#fbbf24', spark: [1150,1148,1145,1143,1142,1141,1141,1168], source: 'fred.stlouisfed.org', sourceUrl: 'https://fred.stlouisfed.org/series/VAFAIR5POP', method: 'API' },
    { id: 'housing',   icon: '🏠', title: 'MEDIAN HOME PRICE', tier: 'published', publishedDate: 'Mar 2026',       countyVal: '$768K',          districtVal: null, sub: 'Up 1.7% YoY. 900 transactions in Mar 2026, up 7.7%.', color: '#f5c842', spark: [600,640,670,695,710,724,754,768], source: 'Bright MLS',    sourceUrl: 'https://teamdda.com/fairfax-county-housing-market-update-for-spring-2026/', method: 'COLLECTED' },
    { id: 'safety',    icon: '👮', title: 'CRIME INDEX',        tier: 'published', publishedDate: 'Jan 2026',       countyVal: '-5% YoY',        districtVal: null, sub: 'FCPD annual report 2025. Year-over-year change.', color: '#fb923c', spark: [100,99,97,96,95,95,95,95], source: 'fairfaxcounty.gov',   sourceUrl: 'https://www.fairfaxcounty.gov/police/crime-statistics', method: 'STATIC' },
    { id: 'schools',   icon: '📚', title: 'SCHOOL PERFORMANCE',tier: 'published', publishedDate: '2025 School Year',countyVal: 'SAT avg 1,183',  districtVal: null, sub: 'Highest avg SAT in Virginia (state avg 1,112). 93.3% on-time graduation.', color: '#f97316', spark: [7.0,7.2,7.5,7.7,7.8,7.9,8.0,8.1], source: 'fcps.edu', sourceUrl: 'https://www.fcps.edu/about-fcps', method: 'STATIC' },
    { id: 'bosvotes',  icon: '🗳', title: 'BOS ACTIVITY',       tier: 'published', publishedDate: 'Apr 2026',       countyVal: 'FY2027 Budget',  districtVal: null, sub: 'FY2027 budget hearings Apr 14-16 2026. Meets monthly.', color: '#f472b6', spark: [3,4,6,5,7,6,7,7], source: 'fairfaxcounty.gov/bos', sourceUrl: 'https://www.fairfaxcounty.gov/bos/minutes', method: 'STATIC' },
    { id: 'elections', icon: '🗳', title: 'ELECTIONS',           tier: 'published', publishedDate: 'Nov 2023',       countyVal: 'Nov 2027 next',  districtVal: null, sub: 'Last general election Nov 7 2023. All 9 supervisors + chair. Next: Nov 2027.', color: '#e879f9', spark: [0,0,0,0,0,0,0,1], source: 'fairfaxcounty.gov/elections', sourceUrl: 'https://www.fairfaxcounty.gov/elections', method: 'STATIC' },
    { id: 'foia',      icon: '📋', title: 'FOIA / OPEN RECORDS',tier: 'published', publishedDate: 'Current',        countyVal: 'File Online',    districtVal: null, sub: 'Virginia FOIA: 5 business days to respond. Free for first 2hrs staff time.', color: '#94a3b8', spark: [10,12,14,15,18,20,22,24], source: 'fairfaxcounty.gov/foia', sourceUrl: 'https://www.fairfaxcounty.gov/foia', method: 'STATIC' },
    { id: 'dominion',  icon: '⚡', title: 'POWER PROVIDER',     tier: 'published', publishedDate: 'Current',        countyVal: 'Dominion Energy', districtVal: null, sub: 'Primary provider. Report outages: 1-866-DOM-HELP (366-4357).', color: '#facc15', spark: [0,0,1,0,2,0,0,1], source: 'dominionenergy.com', sourceUrl: 'https://www.dominionenergy.com/home/outages-and-safety/report-an-outage', method: 'STATIC' },
  ],
